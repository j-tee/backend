    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_amount', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=10)),
                ('batch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sale_items', to='inventory.batch')),
        ...
        migrations.AddIndex(
            model_name='saleitem',
            index=models.Index(fields=['product', 'batch'], name='sales_items_product_16c0be_idx'),
        ),
        migrations.AddIndex(
