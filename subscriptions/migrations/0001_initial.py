# Generated by Django 5.2.6 on 2025-10-14 11:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_storefronts', models.PositiveIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(blank=True, choices=[('MOMO', 'Mobile Money'), ('PAYSTACK', 'Paystack'), ('STRIPE', 'Stripe'), ('BANK_TRANSFER', 'Bank Transfer')], max_length=20)),
                ('payment_status', models.CharField(choices=[('PAID', 'Paid'), ('PENDING', 'Pending'), ('FAILED', 'Failed'), ('OVERDUE', 'Overdue'), ('CANCELLED', 'Cancelled')], default='PENDING', max_length=20)),
                ('status', models.CharField(choices=[('TRIAL', 'Trial'), ('ACTIVE', 'Active'), ('PAST_DUE', 'Past Due'), ('INACTIVE', 'Inactive'), ('CANCELLED', 'Cancelled'), ('SUSPENDED', 'Suspended'), ('EXPIRED', 'Expired')], default='TRIAL', max_length=20)),
                ...
                ('created_by', models.ForeignKey(help_text='User who created this subscription', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_subscriptions', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('alert_type', models.CharField(choices=[('PAYMENT_DUE', 'Payment Due'), ('PAYMENT_FAILED', 'Payment Failed'), ('TRIAL_ENDING', 'Trial Ending'), ('SUBSCRIPTION_EXPIRING', 'Subscription Expiring'), ('SUBSCRIPTION_EXPIRED', 'Subscription Expired'), ('USAGE_LIMIT_WARNING', 'Usage Limit Warning'), ('USAGE_LIMIT_REACHED', 'Usage Limit Reached'), ('SUBSCRIPTION_CANCELLED', 'Subscription Cancelled'), ('PAYMENT_SUCCESS', 'Payment Success'), ('SUBSCRIPTION_SUSPENDED', 'Subscription Suspended'), ('SUBSCRIPTION_ACTIVATED', 'Subscription Activated')], max_length=30)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['subscription', 'alert_type'], name='subscriptio_subscri_fe2a79_idx'), models.Index(fields=['is_read', 'priority'], name='subscriptio_is_read_c44a42_idx'), models.Index(fields=['created_at'], name='subscriptio_created_bd5512_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['business', 'status'], name='subscriptio_busines_2eccc1_idx'),
        ),
        migrations.AddIndex(
            model_name='subscription',
