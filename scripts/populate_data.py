...
class DataPopulator:
    ...
    def setup_base_data(self):
        ...
        # Get existing business - use DataLogique Systems
        from accounts.models import BusinessMembership
        
        self.business = Business.objects.filter(name='DataLogique Systems').first()
        if not self.business:
            # Fallback to first business if DataLogique Systems doesn't exist
